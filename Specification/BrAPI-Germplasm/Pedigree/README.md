...
+ Parameters
    ...
    + familyCode (Optional, string) ... A familyCode representing the family this germplasm belongs to.
    + binomialName (Optional, string) ... The full binomial name (scientific name) of a germplasm
    + genus (Optional, string) ... The scientific genus of a germplasm
    + species (Optional, string) ... The scientific species of a germplasm
    + synonym (Optional, string) ... An alternative name or ID used to reference this germplasm
    + includeParents (Optional, boolean) ... If this parameter is true, include the array of parents in the response
    + includeSiblings (Optional, boolean) ... If this parameter is true, include the array of siblings in the response
    + includeProgeny (Optional, boolean) ... If this parameter is true, include the array of progeny in the response
    + includeFullTree (Optional, boolean) ... Recursively include ALL of the nodes present in this pedigree tree.
    + pedigreeDepth (Optional, integer) ... Recursively include this number of levels up the tree in the response
    + progenyDepth (Optional, integer) ... Recursively include this number of levels down the tree in the response
