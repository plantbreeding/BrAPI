...
<tr><td><span style="font-weight:bold;">units</span></td><td>string</td><td>A description of the things being transferred between SeedLots in a transaction (seeds, bulbs, kg, etc)</td></tr>
</table>
