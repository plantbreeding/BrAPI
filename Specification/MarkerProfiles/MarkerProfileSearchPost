...
+ Parameters
    + markerprofileDbId (optional, string, `993`) ... The server's internal id for the Germplasm ID, as returned by the **Find markerprofile by Germplasm** service. For multiple, repeat the parameter.
