...
### Get - /methods [GET /brapi/v2/methods{?methodDbId}{?observationVariableDbId}{?commonCropName}{?programDbId}{?externalReferenceID}{?externalReferenceId}{?externalReferenceSource}{?page}{?pageSize}]
