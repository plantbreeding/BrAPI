...
<tr><td>eventParameters<br><span style="font-weight:bold;margin-left:5px">.description</span></td><td>string</td><td>A human readable description of this event parameter. This description is ussually associated with the 'name' and 'code' of an event parameter.</td></tr>
