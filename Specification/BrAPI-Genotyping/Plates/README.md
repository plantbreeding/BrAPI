...
+ Parameters
    ...
    + plateDbId (Optional, string) ... The ID which uniquely identifies a `Plate` of `Samples`
    + plateName (Optional, string) ... The human readable name of a `Plate` of `Samples`
...
+ Parameters
    + plateDbId (Required, string) ... The ID which uniquely identifies a `Plate`
    + Authorization (Optional, string) ... HTTP HEADER - Token used for Authorization <strong> Bearer {token_string} </strong>
